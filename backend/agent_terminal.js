...
const ALLOWED_COMMANDS = new Map([
  ...
  ['command', { args: /^-v$/, token: /^[A-Za-z0-9_.+-]+$/ }],
  ...
  ['resolvectl', { args: /^(?:status|query|dns|domain|statistics|reset-statistics)$/, token: /^[A-Za-z0-9_.:-]+$/ }],
  ['systemd-resolve', { args: /^(?:--status|--statistics|--reset-statistics)$/, token: /^[A-Za-z0-9_.:-]+$/ }],
  ...
  ['netstat', { args: FLAG, token: SAFE_TOKEN }],
  ...
  ['vmstat', { args: FLAG, token: /^\d+$/ }],
  ['iostat', { args: FLAG, token: /^\d+$/ }],
  ['mpstat', { args: FLAG, token: /^\d+$/ }],
  ['pidstat', { args: FLAG, token: /^\d+$/ }],
  ['top', { args: /^(?:-b|-n|-o)$/, token: /^\d+|%?[A-Za-z_]+$/ }],
  ['ps', { args: FLAG, token: /^[A-Za-z0-9_,=.-]+$/ }],
  ['pgrep', { args: FLAG, token: /^[A-Za-z0-9_.:-]+$/ }],
  ['pwd', { args: /^$/ }],
  ['ls', { args: FLAG, token: SAFE_TOKEN }],
  ['find', { args: FLAG, token: SAFE_TOKEN }],
  ['stat', { args: /^--?[A-Za-z0-9%][A-Za-z0-9%=-]*$/, token: SAFE_TOKEN }],
  ['file', { args: FLAG, token: SAFE_TOKEN }],
  ['readlink', { args: FLAG, token: SAFE_TOKEN }],
  ['realpath', { args: FLAG, token: SAFE_TOKEN }],
  ['namei', { args: FLAG, token: SAFE_TOKEN }],
  ['getfacl', { args: FLAG, token: SAFE_TOKEN }],
  ['sha256sum', { args: FLAG, token: SAFE_TOKEN }],
  ['md5sum', { args: FLAG, token: SAFE_TOKEN }],
  ['tar', { args: /^(?:-t|-f|-z|-J|-j|-v|--list|--file)$/, token: SAFE_TOKEN }],
  ['unzip', { args: /^(?:-t|-l|-q)$/, token: SAFE_TOKEN }],
  ['zipinfo', { args: FLAG, token: SAFE_TOKEN }],
  ['sqlite3', { args: FLAG, token: SAFE_TOKEN }],
  ['dpkg', { args: /^(?:-l|-s|-L|--print-architecture)$/, token: /^[A-Za-z0-9_.:+-]+$/ }],
  ['apt-cache', { args: /^(?:policy|show|madison)$/, token: /^[A-Za-z0-9_.:+-]+$/ }],
  ['rpm', { args: /^(?:-qa|-qi|-ql)$/, token: /^[A-Za-z0-9_.:+-]+$/ }],
