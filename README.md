...
- The Fixed section keeps a 24-hour repair/action history separate from game console logs. Server console logs stay bounded to the latest 600 in-memory lines and rotate on disk at 4 MB per server log.
